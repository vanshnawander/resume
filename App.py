...
connection = pymysql.connect(host='localhost',user='root',password='vanshr123@&',db='abc')
...
def run():
    ...
    img = Image.open('E:/resume/Smart_Resume_Analyser_App-master/Logo/SRA_Logo.jpg')
    ...
    if choice == 'Normal User':
        ...
        if pdf_file is not None:
            save_image_path = 'E:/resume/Smart_Resume_Analyser_App-master/Uploaded_Resumes'+ pdf_file.name
        ...
        if st.button('Login'):
            if ad_user == 'resume' and ad_password == 'vansh':
                st.success("Welcome vansh")
                # Display Data
